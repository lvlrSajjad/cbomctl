...
- `upstream/normalized-json-from-cli.md` — normalized JSON from the
  sbom-tools CLI, the follow-up their maintainer invited. Unposted.
  (`upstream/issue-draft.md` is done: posted, answered, closed.)
